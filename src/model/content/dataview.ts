...
class BlockContentDataview implements I.ContentDataview {
	...
	constructor(props: I.ContentDataview) {
		...
		this.relationLinks = Array.isArray(props.relationLinks)
			? props.relationLinks
			: [];
		this.groupOrder = Array.isArray(props.groupOrder)
			? props.groupOrder
			: [];
		this.objectOrder = Array.isArray(props.objectOrder)
			? props.objectOrder
			: [];
