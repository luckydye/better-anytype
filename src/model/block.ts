...
class Block implements I.Block {
	...
	isLayoutTableColumns(): boolean {
		return (
			this.isLayout() && this.content.style == I.LayoutStyle.TableColumns
		);
	}
	...
	isFileFile(): boolean {
		return (
			this.isFile() &&
			this.content.type == I.FileType.File &&
			this.isFileStyleLink()
		);
	}
	...
	isFileImage(): boolean {
		return (
			this.isFile() &&
			this.content.type == I.FileType.Image &&
			this.isFileStyleEmbed()
		);
	}
	...
	isFileVideo(): boolean {
		return (
			this.isFile() &&
			this.content.type == I.FileType.Video &&
			this.isFileStyleEmbed()
		);
	}
	...
	isFileAudio(): boolean {
		return (
			this.isFile() &&
			this.content.type == I.FileType.Audio &&
			this.isFileStyleEmbed()
		);
	}
	...
	isFilePdf(): boolean {
		return (
			this.isFile() &&
			this.content.type == I.FileType.Pdf &&
			this.isFileStyleEmbed()
		);
	}
	...
	isEmbedLatex(): boolean {
		return (
			this.isEmbed() && this.content.processor == I.EmbedProcessor.Latex
		);
	}

	isEmbedKroki(): boolean {
		return (
			this.isEmbed() && this.content.processor == I.EmbedProcessor.Kroki
		);
	}
	...
	isEmbedTelegram(): boolean {
		return (
			this.isEmbed() &&
			this.content.processor == I.EmbedProcessor.Telegram
		);
	}
	...
	isEmbedGithubGist(): boolean {
		return (
			this.isEmbed() &&
			this.content.processor == I.EmbedProcessor.GithubGist
		);
	}
	...
	isEmbedSketchfab(): boolean {
		return (
			this.isEmbed() &&
			this.content.processor == I.EmbedProcessor.Sketchfab
		);
	}
	...
	isEmbedBilibili(): boolean {
		return (
			this.isEmbed() &&
			this.content.processor == I.EmbedProcessor.Bilibili
		);
	}
