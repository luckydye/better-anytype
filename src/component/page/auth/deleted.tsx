...
const PageAuthDeleted = observer(
	class PageAuthDeleted extends React.Component<I.PageComponent, State> {
		state = {
			error: "",
		};
			...
			switch (status) {
				case I.AccountStatusType.PendingDeletion: {
					...
					title = U.Common.sprintf(
						translate("pageAuthDeletedAccountDeletionTitle"),
						dt,
					);
					...
					cancelButton = (
						<Button
							type="input"
							text={translate("authDeleteCancelButton")}
				...
				<div>
					...
					<Frame>
						...
						<div className="animation buttons">
							...
							<Button
								color="blank"
								text={translate("authDeleteExportButton")}
								onClick={this.onExport}
							/>
							<div className="remove" onClick={this.onRemove}>
								{translate("authDeleteRemoveButton")}
							</div>
						</div>
					</Frame>
