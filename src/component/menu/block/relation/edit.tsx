...
const MenuBlockRelationEdit = observer(
	class MenuBlockRelationEdit extends React.Component<I.Menu> {
		node: any = null;
		...
		render() {
			...
			if (
				relation &&
				Relation.isSystemWithoutUser(relation.relationKey)
			) {
				canDelete = false;
			}
			...
			switch (ref) {
				case "type":
					deleteText = translate(
						"menuBlockRelationEditUnlinkFromType",
					);
					deleteIcon = "unlink";
					break;
				...
				case "object":
					deleteText = translate(
						"menuBlockRelationEditUnlinkFromObject",
					);
					deleteIcon = "unlink";
					break;
			}
			...
			if (
				...
				opts = (
					<div className="section noLine">
						<div className="name">
							{translate("menuBlockRelationEditLimitObjectTypes")}
						</div>
						<MenuItemVertical
							id="object-type"
		...
		*/
			...
			return (
				...
				>
					<div className="section">
						<div className="name">
							{translate("menuBlockRelationEditRelationName")}
						</div>
					...
					>
						<div className="name">
							{translate("menuBlockRelationEditRelationType")}
						</div>
						<MenuItemVertical
							id="relation-type"
							icon={
							...
							name={
								this.format === null
									? translate(
											"menuBlockRelationEditSelectRelationType",
										)
			...
			this.menuOpen("dataviewObjectValues", {
				...
				data: {
					...
					placeholderFocus: translate(
						"menuBlockRelationEditFilterObjectTypes",
					),
			...
			C.ObjectCreateRelation(item, S.Common.space, (message: any) => {
				...
				Preview.toastShow({
					text: U.Common.sprintf(
						translate("menuBlockRelationEditToastOnCreate"),
						details.name,
					),
				});
