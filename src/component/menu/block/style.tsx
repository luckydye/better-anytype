...
const MenuBlockStyle = observer(
	class MenuBlockStyle extends React.Component<I.Menu> {
		n = -1;
		...
		getSections() {
			...
			const turnText = {
				id: "turnText",
				icon: "",
				name: translate("menuBlockStyleTurnText"),
				color: "",
			...
			const turnList = {
				id: "turnList",
				icon: "",
				name: translate("menuBlockStyleTurnList"),
				color: "",
			...
			const turnDiv = {
				id: "turnDiv",
				icon: "",
				name: translate("menuBlockStyleTurnDiv"),
				color: "",
			...
			const turnFile = {
				id: "turnFile",
				icon: "",
				name: translate("menuBlockStyleTurnFile"),
				color: "",
		...
		onClick(e: any, item: any) {
			...
			selection?.clear();
			analytics.event("ChangeBlockStyle", {
				type: item.type,
				style: item.itemId,
			});
		}
