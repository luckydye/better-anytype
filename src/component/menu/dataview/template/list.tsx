...
const MenuTemplateList = observer(
		...
		render() {
			...
			const ItemBlank = (item: any) => {
				const cn = [
					"previewObject",
					"blank",
					I.PreviewSize[previewSize].toLowerCase(),
				];
			...
			return (
				<div ref={(node) => (this.node = node)}>
					{withTypeSelect ? (
						<div
							id="defaultType"
							className="select big defaultTypeSelect"
							onClick={this.onType}
						>
							<div className="item">
		...
		onKeyDown(e: any) {
			...
			keyboard.shortcut(
				...
				(pressed: string) => {
					...
					const dir = ["arrowup", "arrowleft"].includes(pressed)
						? -1
						: 1;
