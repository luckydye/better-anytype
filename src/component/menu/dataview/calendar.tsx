...
const MenuCalendar = observer(
	class MenuCalendar extends React.Component<I.Menu> {
		originalValue = 0;
		refMonth: any = null;
		refYear: any = null;
				...
				<div className="inner">
					<div className="head">
						<div className="sides">
							...
							<div className="side right">
								<div
									className="btn prevMonth"
									onClick={() =>
										this.setValue(
											this.stepMonth(value, -1),
											false,
											false,
										)
									}
					...
					<div className="body">
						{items.map((item, i) => {
							...
							if (
								dayToday ==
								U.Date.timestamp(item.y, item.m, item.d)
							) {
								cn.push("today");
							}
							if (
