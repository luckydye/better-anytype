...
const MenuTypeSuggest = observer(
	class MenuTypeSuggest extends React.Component<I.Menu, State> {
		state = {
			loading: false,
		};
		...
		getSections() {
			...
			let sections: any[] = [
				{
					id: "library",
					name: translate("menuTypeSuggestMyTypes"),
					children: library,
				},
			];
