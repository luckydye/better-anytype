	...
	class Navigation extends React.Component {
		...
		render() {
			...
			const buttons: any[] = [
				{
					id: "back",
					tooltip: translate("commonBack"),
					caption: cb,
					onClick: this.onBack,
					disabled: !keyboard.checkBack(),
				},
				{
					id: "forward",
					tooltip: translate("commonForward"),
					caption: cf,
				...
				{
					id: "graph",
					tooltip: translate("commonGraph"),
					caption: `${cmd} + ${alt} + O`,
					onClick: this.onGraph,
				},
				{
					id: "search",
		...
		setX(sw: number, animate: boolean) {
			...
			if (animate) {
				window.setTimeout(
					() => node.removeClass("sidebarAnimation"),
					200,
				);
			}
		}
