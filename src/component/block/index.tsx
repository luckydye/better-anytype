...
const Block = observer(
	class Block extends React.Component<Props> {
		...
		render() {
			...
			switch (type) {
				...
				case I.BlockType.IconPage: {
					...
					canDrop = false;
					blockComponent = (
						<BlockIconPage key={key} ref={setRef} {...this.props} />
					);
					break;
				}
				...
				case I.BlockType.IconUser: {
					...
					canDrop = false;
					blockComponent = (
						<BlockIconUser key={key} ref={setRef} {...this.props} />
					);
					break;
				}
				...
				case I.BlockType.File: {
					...
					if (
						!object.isDeleted &&
						content.state == I.BookmarkState.Done
					) {
						cn.push("withContent");
					}
					...
					if (style == I.FileStyle.Link) {
						blockComponent = (
							<BlockFile key={key} ref={setRef} {...this.props} />
						);
						break;
					}
				...
				case I.BlockType.Div: {
					blockComponent = (
						<BlockDiv key={key} ref={setRef} {...this.props} />
					);
					break;
				}
				...
				case I.BlockType.Link: {
					...
					blockComponent = (
						<BlockLink key={key} ref={setRef} {...this.props} />
					);
					break;
				}
				...
				case I.BlockType.Bookmark: {
					...
					blockComponent = (
						<BlockBookmark key={key} ref={setRef} {...this.props} />
					);
					break;
				}
				...
				case I.BlockType.Cover: {
					...
					blockComponent = (
						<BlockCover key={key} ref={setRef} {...this.props} />
					);
					break;
				}
				...
				case I.BlockType.Relation: {
					blockComponent = (
						<BlockRelation key={key} ref={setRef} {...this.props} />
					);
					break;
				}
				...
				case I.BlockType.Featured: {
					...
					blockComponent = (
						<BlockFeatured key={key} ref={setRef} {...this.props} />
					);
					break;
				}
				...
				case I.BlockType.Type: {
					...
					blockComponent = (
						<BlockType key={key} ref={setRef} {...this.props} />
					);
					break;
				}
				...
				case I.BlockType.Embed: {
					blockComponent = (
						<BlockEmbed key={key} ref={setRef} {...this.props} />
					);
					break;
				}
				...
				case I.BlockType.Table: {
					blockComponent = (
						<BlockTable key={key} ref={setRef} {...this.props} />
					);
					break;
				}
		...
		onMenuDown(e: any) {
			...
			focus.clear(true);
			this.ids = selection?.getForClick(
				this.props.block.id,
				false,
				false,
			);
		...
		onContextMenu(e: any) {
			const { focused } = focus.state;
			const { rootId, block, readonly, isContextMenuDisabled } =
				this.props;
			const selection = S.Common.getRef("selectionProvider");
		...
		onResizeStart(e: any, index: number) {
			...
			const offset =
				(prevBlockId
					? node.find("#block-" + prevBlockId).offset().left
					: 0) + J.Size.blockMenu;
		...
		calcWidth(x: number, index: number) {
			...
			const sum =
				(prevBlock.fields.width || dw) +
				(currentBlock.fields.width || dw);
