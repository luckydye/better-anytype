...
import { type I, S, U, translate, Relation } from "Lib";

interface State {
	isEditing: boolean;
}

const CellFile = observer(
	class CellFile extends React.Component<I.Cell, State> {
		state = {
			isEditing: false,
		};
		...
		render() {
			...
			let value: any[] = Relation.getArrayValue(
