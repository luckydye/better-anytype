...
const Notification = observer(
	class Notification extends React.Component<I.NotificationComponent, State> {
		_isMounted = false;
		node: any = null;
		timeout = 0;
		state = {
		...
		render() {
			...
			const spaceCheck =
				spaceview &&
				(spaceview.isAccountRemoving || spaceview.isAccountDeleted);
			const participantCheck =
				participant &&
				(participant.isRemoving || participant.isJoining);
			...
			switch (type) {
				...
				case I.NotificationType.Join: {
					buttons = buttons.concat([
						...
						{
							id: "spaceSwitch",
							text: translate("notificationButtonSpaceSwitch"),
							color: "blank",
						},
					]);
					break;
				...
				case I.NotificationType.Remove: {
					buttons = buttons.concat([
						{
							id: "spaceDelete",
							text: translate("notificationButtonSpaceDelete"),
							color: "red",
						},
					]);
					break;
