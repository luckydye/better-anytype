...
import { type I, S, U, translate, analytics } from "Lib";
...
const PopupMembership = observer(
	class PopupMembership extends React.Component<I.Popup, State> {
		state = {
			isEditing: false,
		};
		...
		render() {
			...
			} else if (!isEditing && membership.tier == tier) {
				content = (
					<PageCurrent
						{...this.props}
				...
				<div className={cn.join(" ")}>
					<div className="side left">
						...
						<div className="contentList">
							<Label
								text={translate("popupMembershipWhatsIncluded")}
							/>
							<ul>
