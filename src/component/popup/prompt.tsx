...
import { type I, translate } from "Lib";

const PopupPrompt = observer(
	class PopupPrompt extends React.Component<I.Popup> {
		refValue: any = null;
		...
		render() {
			...
			const { data } = param;
			const { placeholder, value, maxLength, title, label, readonly } =
				data;
