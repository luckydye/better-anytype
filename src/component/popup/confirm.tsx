...
import { type I, keyboard, translate } from "Lib";
import { observer } from "mobx-react";

const PopupConfirm = observer(
	class PopupConfirm extends React.Component<I.Popup> {
		refButtons: any = null;
		n = 0;
		...
		render() {
			...
			const canConfirm =
				undefined === data.canConfirm ? true : data.canConfirm;
			const canCancel =
				undefined === data.canCancel ? true : data.canCancel;
		...
		onKeyDown(e: any) {
			...
			keyboard.shortcut(
				...
				e,
				(arrow) => {
					const dir = ["arrowup", "arrowleft"].includes(arrow)
						? 1
						: -1;
					const buttons = $(this.refButtons).find(".button");
