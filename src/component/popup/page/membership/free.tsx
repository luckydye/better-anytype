...
const PopupMembershipPageFree = observer(
	class PopupMembershipPageFree extends React.Component<I.Popup, State> {
		state = {
			verificationStep: 1,
			countdown: 60,
			hasCountdown: false,
				...
				case 1: {
					content = (
						<form onSubmit={this.onVerifyEmail}>
							<Title
								text={translate(
									`popupMembershipFreeTitleStep1`,
								)}
							/>
							<Label
								text={translate(`popupMembershipFreeText`)}
							/>
							...
							<div className="inputWrapper">
								<Input
									...
									placeholder={translate(`commonEmail`)}
								/>
							</div>
							...
							<div className="check" onClick={this.onCheck}>
								<Checkbox
									...
									value={false}
								/>{" "}
								{translate("popupMembershipFreeCheckboxText")}
							</div>
				...
				case 2: {
					content = (
						<React.Fragment>
							<div
								onClick={() =>
									this.setState({ verificationStep: 1 })
								}
								className="back"
							>
								<Icon />
