	...
	render() {
		return (
			<div>
				...
				/>
				<Title
					text={translate("popupSettingsImportNotionWarningTitle")}
				/>
					...
					<ol className="list">
						<li
							...
							dangerouslySetInnerHTML={{
								__html: U.Common.sanitize(
									translate(
										"popupSettingsImportNotionWarningLi1",
									),
								),
							}}
						/>
						<li
							...
							dangerouslySetInnerHTML={{
								__html: U.Common.sanitize(
									translate(
										"popupSettingsImportNotionWarningLi2",
									),
								),
							}}
						/>
						<li
							...
							dangerouslySetInnerHTML={{
								__html: U.Common.sanitize(
									translate(
										"popupSettingsImportNotionWarningLi3",
									),
								),
							}}
						/>
						<li
							...
							dangerouslySetInnerHTML={{
								__html: U.Common.sanitize(
									translate(
										"popupSettingsImportNotionWarningLi4",
									),
								),
							}}
						/>
				...
				<Button
					className="c36"
					text={translate("popupSettingsImportNotionWarningProceed")}
