...
import { type I, U, translate } from "Lib";
			...
			<div>
				...
				<Label
					...
					text={U.Common.sprintf(
						translate("popupSettingsImportNotionHelpStep"),
						1,
					)}
				/>
				<ol className="list">
					<li>
						<Label
							text={translate(
								"popupSettingsImportNotionHelpStep11",
							)}
						/>
					...
					<li>
						<Label
							text={translate(
								"popupSettingsImportNotionHelpStep12",
							)}
						/>
					...
					<li>
						<Label
							text={translate(
								"popupSettingsImportNotionHelpStep13",
							)}
						/>
					...
					<li>
						<Label
							text={translate(
								"popupSettingsImportNotionHelpStep14",
							)}
						/>
					...
					<li>
						<Label
							text={translate(
								"popupSettingsImportNotionHelpStep15",
							)}
						/>
					...
					<li>
						<Label
							text={translate(
								"popupSettingsImportNotionHelpStep16",
							)}
						/>
				...
				<Label
					...
					text={translate("popupSettingsImportNotionHelpStep2Descr")}
				/>
				<ol className="list">
					<li>
						<Label
							text={translate(
								"popupSettingsImportNotionHelpStep21",
							)}
						/>
					...
					<li>
						<Label
							text={translate(
								"popupSettingsImportNotionHelpStep22",
							)}
						/>
