...
import { type I, C, S, U, translate, analytics, Renderer } from "Lib";
...
const PopupSettingsPageLogout = observer(
	class PopupSettingsPageLogout extends React.Component<
		I.PopupSettings,
		State
	> {
		node: any = null;
			...
			return (
				<div ref={(node) => (this.node = node)}>
					...
					<Label
						...
						text={translate("popupSettingsPhraseText")}
					/>
					...
					<div className="buttons">
						<Button
							className="c36"
							text={translate("popupSettingsPhraseBackup")}
							onClick={this.onCopy}
						/>
						<Button
							color="red"
							className="c36"
							text={translate("popupSettingsLogout")}
