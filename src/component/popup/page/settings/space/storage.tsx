...
const PopupSettingsPageStorageManager = observer(
	class PopupSettingsPageStorageManager extends React.Component<
		I.PopupSettings,
		{}
	> {
		ref = null;
		...
		render() {
			...
			const filters: I.Filter[] = [
				{
					...
					relationKey: "fileSyncStatus",
					condition: I.FilterCondition.Equal,
					value: I.FileSyncStatus.Synced,
				},
			];
			const sorts: I.Sort[] = [
			...
			return (
				<div className="wrap">
					...
					<Title
						text={translate(
							"popupSettingsSpaceStorageManagerTitle",
						)}
					/>
					...
					<ListObjectManager
						...
						filters={filters}
						textEmpty={translate(
							"popupSettingsSpaceStorageManagerEmptyLabel",
						)}
					/>
				</div>
			);
