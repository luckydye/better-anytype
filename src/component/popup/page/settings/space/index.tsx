...
const PopupSettingsSpaceIndex = observer(
	...
	> {
		...
		render() {
			...
			const progressSegments = (spaces || [])
				.map((space) => {
					const object: any =
						S.Common.spaceStorage.spaces.find(
							(it) => it.spaceId == space.targetSpaceId,
						) || {};
					...
					return {
						name: space.name,
						caption: U.File.size(usage),
						percent: usage / bytesLimit,
			...
			const isRed =
				...
				localUsage > bytesLimit;

			if (
				personalSpace &&
				sharedCnt >= personalSpace.sharedSpacesLimit &&
				!space.isShared
			) {
				canShare = false;
				canMembers = false;
			...
			if (isRed) {
				...
				buttonUpgrade = (
					<Button
						className="payment"
						text={translate(
							"popupSettingsSpaceIndexRemoteStorageUpgradeText",
						)}
			...
			return (
				<React.Fragment>
						...
						<div className="headerContent">
							...
							<div className="info">
								<Label
									...
									text={translate(
										`spaceAccessType${space.spaceAccessType}`,
									)}
								/>
								...
								<Label
									...
									text={translate(
										"popupSettingsSpaceIndexInfoLabel",
									)}
					...
					<div className="sections">
							...
							onMouseEnter={
								isShareActive
									...
									: (e) =>
											Preview.tooltipShow({
												text: translate(
													"popupSettingsSpaceShareGenerateInviteDisabled",
												),
						...
						>
							<Title
								text={translate(`popupSettingsSpaceShareTitle`)}
							/>
									...
									>
										<div className="sides">
											<div className="side left">
												<Title
													text={translate(
														"popupSettingsSpaceIndexShareShareTitle",
													)}
												/>
												<Label
													text={translate(
														"popupSettingsSpaceIndexShareDefaultText",
													)}
												/>
											</div>
									...
									>
										<div className="sides">
											<div className="side left">
												...
												<Label
													text={translate(
														"popupSettingsSpaceIndexShareInviteText",
													)}
												/>
											</div>
											<div className="side right">
									...
									<div className="item isInvite">
										<div className="sides">
											<div className="side left">
												<Title
													text={translate(
														"popupSettingsSpaceIndexShareLinkTitle",
													)}
												/>
												<Label
													text={translate(
														"popupSettingsSpaceIndexShareLinkText",
													)}
												/>
											</div>
											<div className="side right">
									...
									>
										<div className="sides">
											<div className="side left">
												<Title
													text={translate(
														"popupSettingsSpaceIndexShareMembersTitle",
													)}
												/>
												<Label
													text={translate(
														"popupSettingsSpaceIndexShareMembersManageText",
													)}
												/>
											</div>
											<div className="side right">
									...
									>
										<div className="sides">
											<div className="side left">
												...
												<Label
													text={translate(
														"popupSettingsSpaceIndexShareMembersViewText",
													)}
												/>
											</div>
											<div className="side right">
						...
						{canWrite ? (
							<div className="section sectionSpaceManager">
								<Title
									text={translate(
										`popupSettingsSpaceIndexManageSpaceTitle`,
									)}
								/>
								<div className="sectionContent">
									{isOwner ? (
										<div className={usageCn.join(" ")}>
											<div className="sides alignTop">
												<div className="side left">
													<Title
														text={translate(
															`popupSettingsSpaceIndexRemoteStorageTitle`,
														)}
													/>
													<div className="storageLabel">
														<Label
															text={U.Common.sprintf(
																translate(
																	`popupSettingsSpaceIndexStorageText`,
																),
																U.File.size(
																	bytesLimit,
																),
												...
												<div className="side right">
													{canWrite ? (
														<Button
															...
															text={translate(
																"popupSettingsSpaceIndexStorageManageFiles",
															)}
															color="blank"
															className="c28"
														/>
											...
											<ProgressBar
												...
												current={U.File.size(bytesUsed)}
												max={U.File.size(bytesLimit)}
											/>
									...
									<div className="item">
										<div className="sides">
											<div className="side left">
												...
												<Label
													text={translate(
														"popupSettingsSpaceIndexHomepageDescription",
													)}
												/>
											</div>
									...
									<div className="item">
										<div className="sides">
											<div className="side left">
												<Title
													text={translate(
														"popupSettingsPersonalDefaultObjectType",
													)}
												/>
												<Label
													text={translate(
														"popupSettingsPersonalDefaultObjectTypeDescription",
													)}
												/>
											</div>
						...
						<div className="section sectionIntegrations">
							<Title
								text={translate(
									`popupSettingsSpaceIndexIntegrations`,
								)}
							/>
							<div className="sectionContent">
								{canWrite ? (
						...
						<div className="section sectionInfo">
							<Title
								text={translate(
									`popupSettingsSpaceIndexSpaceInfoTitle`,
								)}
							/>
							...
							<div className="sectionContent">
								<div
									...
									onClick={() =>
										U.Common.copyToast(
											translate(
												`popupSettingsSpaceIndexSpaceIdTitle`,
											),
											space.targetSpaceId,
										)
									}
								...
								<div
									...
									onClick={() =>
										U.Common.copyToast(
											translate(
												"popupSettingsAccountAnytypeIdentityTitle",
											),
											account.id,
										)
									}
								>
									<div className="sides">
										<div className="side left">
											<Title
												text={translate(
													`popupSettingsSpaceIndexCreatedByTitle`,
												)}
											/>
											<Label
												text={
								...
								<div
									...
									onClick={() =>
										U.Common.copyToast(
											translate(
												`popupSettingsSpaceIndexNetworkIdTitle`,
											),
											account.info.networkId,
										)
									}
								>
									<div className="sides">
									...
									<div className="item">
										<div className="sides">
											<div className="side left">
												<Title
													text={translate(
														`popupSettingsSpaceIndexCreationDateTitle`,
													)}
												/>
												<Label
													text={U.Date.date(
		...
		onDashboard() {
			U.Menu.dashboardSelect(
				`#${this.props.getId()} #empty-dashboard-select`,
			);
		}
		...
		onUpgrade() {
			...
			analytics.event("ClickUpgradePlanTooltip", {
				type: "storage",
				route: analytics.route.settingsSpaceIndex,
			});
		}
		...
		onCopy() {
			...
			U.Common.copyToast(
				"",
				U.Space.getInviteLink(cid, key),
				translate("toastInviteCopy"),
			);
		...
		getRequestCnt(): number {
			return U.Space.getParticipantsList([
				I.ParticipantStatus.Joining,
				I.ParticipantStatus.Removing,
			]).length;
		}

		getSharedCnt(): number {
			return U.Space.getList().filter(
				(it) => it.isShared && U.Space.isMyOwner(it.targetSpaceId),
			).length;
		}
	},
);
