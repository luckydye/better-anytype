...
import { type I, Storage, translate } from "Lib";
...
const PopupSettingsPagePinSelect = observer(
	class PopupSettingsPagePinSelect extends React.Component<
		I.PopupSettings,
		State
	> {
		state = {
			...
			return (
				<div>
					...
					<Title
						text={translate(
							pin
								? "popupSettingsPinSelectRepeat"
								: "popupSettingsPinSelect",
						)}
					/>
					<Pin
