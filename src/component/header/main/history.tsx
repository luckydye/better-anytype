...
import { type I, S, U, keyboard } from "Lib";

interface State {
	version: I.HistoryVersion;
}

const HeaderMainHistory = observer(
	class HeaderMainHistory extends React.Component<I.HeaderComponent, State> {
		state = {
			version: null,
		};
			...
			return (
				<React.Fragment>
					...
					<div className="side center">
						<div className="txt">
							{version
								? U.Date.date("M d, Y g:i:s A", version.time)
								: ""}
						</div>
					</div>
