...
import { type I, S, J, Dataview } from "Lib";
import Group from "./group";

const WidgetViewBoard = observer(
	class WidgetViewBoard extends React.Component<I.WidgetViewComponent> {
		node = null;
