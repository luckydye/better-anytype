...
const video = (src: string, c?: string) =>
	text(
		`<video src="${J.Url.cdn}/img/help/${src}" controls class="c70 ${c || ""}" />`,
	);
const img = (src: string, c?: string) =>
	text(`<img src="${J.Url.cdn}/img/help/${src}" class="c70 ${c || ""}" />`);
...
export default [
	...
	h3(`Vault UI 🌐`),
	text(
		`We introduced a sleek display column to quickly create & move between Spaces. We also reworked the previous sidebar logic by removing the floating mode.`,
	),
	img(`42/4.png`),

	h3(`New Widgets 🖼️`),
	text(
		`Widgets can now display all the custom View options as their Sets, including Calendar, Kanban, Gallery and filtered Tag views.`,
	),
	img(`42/1.png`),

	h3(`Sync Status Upgrade 🔄`),
	text(
		`More informative sync status for Objects, Files, and Spaces, including indicators like "Error" for Wi-Fi issues, "Offline" for no network connection.`,
	),
	img(`42/3.png`),

	h3(`Simplified App Sharing 🔗`),
	text(
		`Easily grab a link to share Anytype with others directly from the help menu on Desktop.`,
	),
	img(`42/5.png`),

	h2(`🪷 Quality-of-Life`),
	bullet(
		`You can now use crypto (BTC, ETH, USDT, USDC, BNB, Dai, etc.) to pay for memberships.`,
	),
	bullet(
		`Navigate Tables using only arrow keys to enter, jump cells &amp; exit to the next block. Thanks, @Code-Jack!`,
	),
	bullet(
		`Added an option to copy the URL from bookmark blocks. Thanks, @maxitg!`,
	),
	bullet(
		`Reduced mouse action needed after creating a new page in Collections. Thanks, @Code-Jack!`,
	),
	bullet(
		`"Turn into Object" adapts to default Templates now. Thanks, @${link("https://community.anytype.io/t/turn-into-object-did-not-adapt-to-default-template/21983", "LSK")}!`,
	),
	bullet(
		`Added Option to disable preview on graph view. Thanks, @${link("https://community.anytype.io/t/21898", "iamWing")}!`,
	),
	bullet(
		`Typed text after a linked object no longer becomes part of the link and can be unlinked. Thanks, @${link("https://community.anytype.io/t/8075", "floseq")}!`,
	),
	bullet(
		`Select all ${hl(`${cmd} + A`)} twice now excludes the title. Thanks, @${link("https://community.anytype.io/t/ctrl-a-behaviour-inconsistent-unpredictable/7612", "qualquertipo")}!`,
	),
	...
	h2(`🦂 Bug Fixes`),
	bullet(
		`Mermaid diagrams now display correctly with dark mode backgrounds. Thanks, @${link("https://community.anytype.io/t/20228", "BoxOfWood")}!`,
	),
	bullet(
		`Top menu no longer shows up below the cover in sets when using the modal window. Thanks, ${link("https://community.anytype.io/t/22009", "Elias")}!`,
	),
	bullet(
		`Fixed a problem with carriage when adding tags or objects to corresponding relations. Thanks, @${link("https://community.anytype.io/t/10219", "dzlg")}!`,
	),
	bullet(
		`Relations with number type can now have a value of 0. Thanks, @${link("https://community.anytype.io/t/cant-store-0-s-in-a-number-type-relation/3583", "gcsapo")}!`,
	),
	bullet(
		`Widget pop-ups at the bottom of the sidebar are no longer hidden by the app border. Thanks, @${link("https://community.anytype.io/t/19954", "Tamalika")}!`,
	),
	bullet(
		`Deleted media files now appear as non-existent when embedded in an object. Thanks, @${link("https://community.anytype.io/t/deleted-files-are-not-shown-as-deleted/11208", "Balcion")}!`,
	),
	bullet(
		`First sentence of an Object no longer appears on title bar when the app is locked. Thanks, @${link("https://community.anytype.io/t/21551", "NoteMyBrain")}`,
	),
	bullet(
		`Search pane now displays correctly on smaller screen sizes. Thanks, @${link("https://community.anytype.io/t/22130", "C.c.")}!`,
	),
	bullet(
		`Search in Relation options now shows results even if options were scrolled.`,
	),
	bullet(
		`Checkbox sorting in Set has been restored. Thanks, @${link("https://community.anytype.io/t/22266", "effreyh")}!`,
	),
	bullet(`The Query of the set now updates correctly in the pop-up.`),
	bullet(
		`Fixed issue with using library images for type Icons. Thanks, @${link("https://community.anytype.io/t/22297", "Self-Perfection")}!`,
	),
	bullet(
		`Keyboard cursor no longer disappears after cutting a whole line (block). Thanks, @${link("https://community.anytype.io/t/20781", "Filip")}!`,
	),
	...
	text(
		`You didn't think we'd let Spring slip by before sneaking in a release, did you?`,
	),
	text(
		`This request has been a long-time coming, so it brings us great pleasure to present V1 of Batch Relation Editing!`,
	),
	text(
		`Wave goodbye to the days of tediously managing objects one by one. This new function allows you to add Tags and Relations to many Objects at a time, making it much quicker to organize your content and tidy-up your graph.`,
	),

	h2(`🌿 Quality-of-Life Improvements:`),
	bullet(
		`<b>Improved Global Search:</b> Highlights results, shows more total results, searches by text relations, blocks, tags, and statuses, and allows searching links & backlinks.`,
	),
	video(`40.5/3.mp4`),
	bullet(
		`<b>Batch Relation Editing:</b> Easily manage Tags & Relations across multiple objects 📋`,
	),
	video(`40.5/1.mp4`),
	bullet(
		`<b>Reuse Files:</b> Incorporate existing files within file blocks in the editor 📂 `,
	),
	video(`40.5/2.mp4`),
	bullet(
		`<b>Keyboard shortcut:</b> ${hl(`${cmd} + Enter`)} checks and unchecks checkboxes ✅ Thanks, @${link("https://github.com/anyproto/anytype-ts/pull/709", "mikailcf")}!`,
	),
	bullet(
		`<b>Text Justification:</b> New option to justify text in blocks for better formatting 📄`,
	),
	img("40.5/4.png"),
	bullet(
		`<b>Enhanced Graph Settings:</b> Distinct settings for global and local graphs in Sets/Collections ⚙️ Thanks, @${link("https://community.anytype.io/t/graph-view-with-space-local-graph-clashes/20599", "Donatas")}`,
	),
	bullet(
		`<b>Drag'n'Drop Widgets:</b> Improved widget headers and linked widgets for easier organization 🖱️ Thanks, @${link("https://community.anytype.io/t/drag-drop-not-working-for-sidebar-widgets-with-link-appearance/20195", "siouso")}`,
	),
	bullet(
		`<b>Link Block:</b> Default link style has been changed to Card. Personalize this behaviour in Settings 🔗`,
	),
	img("40.5/5.png"),
	bullet(
		`<b>Version History: </b> Now available in Sets & Collections with a new design that groups changes by Space members and edit time, and highlights changes in the Object 📝🔄`,
	),

	bullet(
		`<b>Gallery View Adjustment:</b> Better visual experience with fewer cards in inline set columns 🎨 Thanks, @${link("https://community.anytype.io/t/change-dynamically-the-width-of-gallery-items-when-on-2col-layout/15623", "Eban")}`,
	),
	...
	h2(`🛠️ Technical Updates:`),
	bullet(
		`Electron updated to ${link("https://releases.electronjs.org/releases/stable", "30.1.0")}`,
	),
	bullet(
		`<b>Membership System:</b> All email domains now supported 📧 Thanks, @Afonso!`,
	),
	bullet(`<b>App Updates:</b> Now works even without logging in ⬆️`),

	h2(`🐞 Bug Fixes:`),
	bullet(
		`<b>Slash Menu:</b> Now shows only after a space character to prevent saving issues ✨ Thanks, @${link("https://community.anytype.io/t/dont-show-the-slash-menu-if-there-is-a-character-or-nunber-direct-before-the-cursor/20500", "code-jack")}`,
	),
	bullet(
		`<b>Task Checkbox:</b> Fixed the issue of checkbox deleting object names in sets ✅`,
	),
	bullet(
		`<b>Editor:</b> Fixed a bug that was breaking the editor when object was opened from history or by deeplink 🌐`,
	),
	bullet(
		`<b>URL Relation Bug:</b> Resolved the issue with opening Windows Explorer when the URL is blank 🖥️ Thanks, @${link("https://community.anytype.io/t/pasting-a-url-in-url-relation-within-a-collection-press-enter-opens-this-pc-on-windows/11197", "hexara")}`,
	),
	bullet(
		`<b>Emoji Markdown:</b> Fixed markdown sequence issues with text blocks starting with an emoji 😃 Thanks, @${link("https://community.anytype.io/t/13159", "pavloUA")}`,
	),
	bullet(
		`<b>System Relations:</b> System relations can now be unlinked from Types 🔗 Thanks, @${link("https://community.anytype.io/t/16517", "filip")}`,
	),
	bullet(
		`<b>Shift + Click:</b> Proper functionality for shift+click on Link/Bookmark blocks 🔍 Thanks, @${link("https://community.anytype.io/t/20194", "siousu")}`,
	),
	bullet(
		`<b>White Flash Issue:</b> Fixed the white flash when returning to the main screen from login/signup 💡`,
	),
	bullet(`<b>Settings Modal:</b> Now properly adjusts to window height 🖥️`),
	bullet(
		`<b>Deeplink Routing:</b> Correct redirection after PIN check 🔒 Thanks, @${link("https://community.anytype.io/t/gallerys-open-in-app-button-failed-to-trigger-while-when-the-app-is-closed/12968", "JorgeE")}`,
	),
	bullet(
		`<b>Delete Link:</b> Fixed the delete link in the space context menu and local-only mode ❌`,
	),

	text(``),
	text(
		`Enjoy and keep an eye out for our next release featuring another banger: 💥Tags as Objects 🏷️`,
	),
	...
	text(
		`Folks, this is the one we’ve been waiting for. This release, in which creating trusted networks with your friends, family and communities in Anytype becomes a reality, is the culmination of nearly five years of R&D.`,
	),
	text(
		`What does this mean for you? Now you can share what matters, with those you care about, knowing that everything you share is encrypted and owned by you. Not anytype, nor anybody else can peek inside or deny your access.`,
	),
	text(
	...
	text(
		`If you need inspiration, you can always check the ${link("https://gallery.any.coop/Collaboration", "Multiplayer Experiences")} newly added to the Experience Gallery - for communities, neighbors, families, teams, and digital creators.`,
	),
	text(
		`We can’t wait to see what you’ll create, and look forward to this new, networked era of Anytype.`,
	),
	...
	video(`40/1.mp4`),
	text(
		`To experience local-first collaboration for yourself, first ${hl("create a new space")} using the space navigation menu. In the Space Settings menu, you’ll see the option to ${hl("Share Space")}. By clicking here, you can generate an invite link for the Space, which can be sent to anyone.`,
	),
	text(
	...
	video(`40/2.mp4`),
	text(
		`For those of you who’ve inquired how to support Anytype’s development and growth, we’re pleased to share that the time has come! Memberships in the Anytype network are now live. You can check your Membership status at any time by clicking on the new ${hl("Memberships")} tab in your Profile Settings.`,
	),
	text(
		`If you joined Anytype prior to this release, you should be auto-updated to the ‘Beta Users’ Plan, which includes your previous storage limits plus all benefits of the Explorer Plan.`,
	),
	text(
		`If you would like to upgrade your membership, select your desired plan and follow the on-screen instructions to submit the Name you would like to purchase on the Anytype network. Then, complete the transaction in Stripe. Once your payment has been confirmed, your membership plan will update in the app.`,
	),
	...
	video(`40/3.mp4`),
	text(
		`With this release, we also introduce greater customization over UX patterns. When clicking on your Profile > Preferences, you’ll see new options for personalizing your account including Quick Capture Menu display settings, default Link Appearance settings, and whether Objects open in Full-Screen view.`,
	),

	h3(`${hl("Graph")} Added as Layout View to Sets & Collections`),
	video(`40/5.mp4`),
	text(
		`For those of you who’ve longed for more precise graph filters, this release brings us one step closer. As a new layout option in Sets & Collections, you’ll now see an option for ${hl("Graph")}. By selecting it, you’ll be able to visualize filtered view of your graph which contains objects that match your Set or Collection criteria. This would allow you to use your graph to view for instance, all objects with Priority: High, or all objects with Type: Book.`,
	),

	h3(`Files & Media Relation Formats added to Set Filter Menu`),
	video(`40/4.mp4`),
	text(
		`When filtering Sets that use File and Media relations, the Set filter menu now includes options to filter according to relations with type: File and Media.`,
	),

	h3(`Design Improvements in Widgets`),
	text(
		`Border radiuses on widget select and hover menus have been adjusted for better visual consistency.`,
	),

	h3(`System Tray & Menu Settings Renamed on Windows & Linux`),
	text(
		`For better consistency with OS naming conventions, ${hl("System Menu")} has been renamed to ${hl("Menu Bar")}, and ${hl("Menu Bar")} has been renamed to ${hl("System Tray")} on Windows and Linux versions`,
	),

	h3(`Use Uploaded Images as Object Icons`),
	text(
		`You can now set an object icon by reusing an image that has already been uploaded to the space.`,
	),
	...
	h2(`🐛 Bug Fixes:`),
	bullet(
		`Brave Browser automatic pairing issue resolved in Web-clipper. Thanks, ${link("https://community.anytype.io/t/web-clipper-not-pairing-automatically/17214", "anicholslcsw")}!`,
	),
	bullet(
		`Maximum relation menu height corrected so set filters are no longer cut off. Thanks, ${link("https://community.anytype.io/t/filter-in-set-view-dont-show-all-available-relations/18504", "Henri")}!`,
	),
	bullet(
		`Experience Gallery links now open Experience page, rather than list of experiences`,
	),
	bullet(
		`Inline Kanban sets no longer overlap with editor content. Thanks, ${link("https://community.anytype.io/t/inline-set-kanban-view-bleeds-over-pre-existing-text/17485", "zma17")}!`,
	),
	bullet(
		`Clipboard paste for large amount of content has been greatly optimized`,
	),
	bullet(
	...
	bullet(
		`When creating link blocks or inline links, first item in Link selection menu no longer being skipped on when using downward arrow key. Thanks, ${link("https://community.anytype.io/t/add-link-menu-first-item-is-always-skipped-keyboard-navigation/18815", "siousu")}!`,
	),
	bullet(`Source relation now opens correctly from featured relations`),
	bullet(
		`Relation filter in Graph fixed to display Objects connected by Relation only. Thanks, ${link("https://community.anytype.io/t/graph-doesnt-show-all-objects-connected-by-relation/18920", "Code-Jack")}!`,
	),
	bullet(
		`Text select with keyboard command now includes last character in selection. Thanks, ${link("https://community.anytype.io/t/selecting-text-with-the-arrow-keys-last-typed-character-is-missed-in-the-selection/18507", "Code-Jack")}!`,
	),
	bullet(
		`Contents inside closed toggles now being selected when copying or moving. Thanks, ${link("https://community.anytype.io/t/contents-not-selected-inside-collapsed-toggle-blocks-when-copying-or-moving/18857", "yuriy144")}!`,
	),
	bullet(`Content can now be dragged and dropped into empty toggles`),
	bullet(
		`Link and bookmark cards no longer resizing when leaving and returning to an object. Thanks, ${link("https://community.anytype.io/t/link-preview-as-card-with-page-cover-in-columns-dont-keep-larger-size-after-leaving-the-object/16642", "nathan.connor")}!`,
	),
	bullet(
		`Inline set & collection titles no longer being cut-off. Thanks, ${link("https://community.anytype.io/t/collections-title-gets-cut-out-after-a-few-characters/16190", "Lixz")}!`,
	),
	bullet(
		`Cursor no longer jumping when using backspace in lines that contain inline @mentions. Thanks, ${link("https://community.anytype.io/t/using-backspace-on-a-line-with-multiple-links-is-causing-issues/19135", "tomshreds")}!`,
	),
	...
	h1(
		`Release 0.39.0 - Webclipper, Files as Objects and Experience Gallery Galore!`,
	),
	text(
		`Midwinter greetings, Anytypers! As we chug along towards multiplayer, we’re excited to bring you another release packed with some long-anticipated features. We hope you’ll enjoy this update and as always, look forward to hearing your feedback!`,
	),
	...
	video("39/1.mp4"),
	text(
		`The wait is over - we’re so relieved to bring you v1 of the Anytype webclipper. For those of you using Chrome browsers, you’ll be able to install the Anytype web clipper using ${link(J.Url.webclipper, "this link")}.`,
	),
	text(`Once installed, you have two options to save content from the web:`),
	bullet(
		`Click the web clipper extension icon in your toolbar to save web pages as new objects in Anytype.`,
	),
	bullet(
		`Select a text snippet, right click, and add the text to any previously-created object in your space.`,
	),

	h3(`Files as Objects`),
	video("39/2.mp4"),
	text(
		`A huge update for your Anytype files: you can now rename and add relations to your files, making it much easier to sort and manage your images, videos, PDFs, and other files. In addition, you can link files to objects by using the @ mention or Link-to commands from your object editor.`,
	),
	...
	text(
		`For easier batch exporting, the right-click menu in sets and collections now includes the ${hl(`Export`)} option. When clicking ${hl(`Export`)}, a popup will appear asking you to define your export settings.`,
	),

	h3(`Right-click Menu added to Objects in Library`),
	video("39/4.mp4"),
	text(
		`When opening types or relations from your library, you can now multi-select the objects from the list and right-click to batch edit object type, delete, export, or add to favorites. You can also select individual objects and create widgets from them.`,
	),

	h3(
		`Widgets for Recently Opened / Recently Edited Objects Now Grouped by Date`,
	),
	video("39/5.mp4"),
	text(
		`When opening your widgets for Recently Opened or Recently Edited Objects, you can now see which Objects fall under Today, Yesterday, Past 7 days, and Older.`,
	),

	h3(
		`Kroki, Sketchfab, and Github Gist Embeds Can be Created by Pasting Links`,
	),
	text(
		`No need to create an embed block first - you can simply paste the links in your object editor and see the option to paste as embed.`,
	),

	h3(`${hl(`Import Type`)} Relation has been Added`),
	text(
		`Objects which have been installed or imported, such as use cases or export files, will now come with relation: Import Type indicating the imported format, which can be Any-block, Markdown, or other.`,
	),

	h3(`Corner Radiuses for Selected Blocks have been Updated`),
	text(
		`For better visual consistency, corner radiuses for blocks in the editor have been updated.`,
	),

	h3(`Graph and Flow Added to Global Search`),
	text(
		`You can now use the global search menu to navigate to your Graph and Flow tabs.`,
	),

	h3(`Czech, Lithuanian, and Korean Added to Interface Languages`),
	text(
		`Thanks to everyone who’s contributed to these three new translations, we now have 22 languages available on Desktop!`,
	),
	...
	h2(`🐛 Bug Fixes:`),
	bullet(
		`Change Object Type menu no longer includes current object type. Thanks, ${link("https://community.anytype.io/t/current-object-type-should-not-be-in-the-list-when-changing-to-other-type/8063/5", "sambouwer")}!`,
	),
	bullet(
		`Title block spacing remains consistent no matter how many blocks are in the object. Thanks, ${link("https://community.anytype.io/t/title-line-spacing-gets-squished-with-more-than-39-blocks/12850", "SpaceLemon")}!`,
	),
	...
	bullet(`CodePen`),
	bullet(
		`Sketchfab models. Thanks, @${link("https://github.com/LavaCxx", "LavaCxx")}!`,
	),
	bullet(
		`Kroki diagrams. Thanks, @${link("https://github.com/LavaCxx", "LavaCxx")}!`,
	),
	bullet(
		`Bilibili videos. Thanks, @${link("https://github.com/LavaCxx", "LavaCxx")}!`,
	),
	...
	text(
		`We’d like to thank our first ANY Experience contributors, @Hexara7777 and @ChristianHaake for submitting five new experiences to the gallery! Between Zen systems, PARA systems and meeting notes, we’re so excited to have your help enriching the Experiences in the Gallery. `,
	),
	...
	img(`38/4.png`),
	text(
		`To help you better make use of your featured relations, empty-state featured relations now display the relation name so you know what they refer to. Clicking the relation will open the relation selection dropdown - either in the object’s relations panel or directly in the editor.s`,
	),
	...
	h3(`Sidebar:`),
	bullet(
		`Auto show/hide of sidebar now works properly. Thanks, ${link("https://community.anytype.io/t/prolonged-sidebar-persistence/9543", "andre")}!`,
	),
	bullet(
		`${hl(`Ctrl + \\`)} now properly toggles the sidebar open and closed. Thanks, ${link("https://community.anytype.io/t/commands-for-toggling-sidebar-dont-work/9661", "andre")}!`,
	),
	bullet(
		`Sidebar width is now fixed after using keyboard shortcuts ${hl(`Ctrl + .`)} or ${hl(`Ctrl + \\`)}. Thanks, ${link("https://community.anytype.io/t/sidebar-width-resets-to-default-after-using-ctrl-or/11900", "Hexara")}!`,
	),
	bullet(
		`Floating sidebar no longer disappears after resizing window. Thanks, ${link("https://community.anytype.io/t/resizing-the-window-makes-the-non-fixed-side-bar-disappear/9442", "SwiftyChicken")}!`,
	),
	bullet(
		`To prevent glitches, sidebar resizing logic when sidebar is collapsed has been updated.`,
	),
	bullet(`Sidebar is now always present when launching the app.`),
	bullet(
		`Tree widgets with linked collections can now be expanded to view contents of collection.`,
	),

	h3(`Sets & Relations:`),
	bullet(
		`Combo box is no longer cut off at right edge of window in Set: Grid View. Thanks, ${link("https://community.anytype.io/t/minor-grid-view-layout-bug-combo-box-cut-off-at-window-border/12868", "halr9000")}!`,
	),
	bullet(
		`Right-clicking on tags in sets no longer opens object action menu. Thanks, ${link("https://community.anytype.io/t/a-right-click-on-a-tag-in-a-table-view-set-or-collection-goof/12759", "Code-Jack")}!`,
	),
	bullet(
		`Kanban sets with five or more tags no longer causes a vertical scrollbar to appear. Thanks, ${link("https://community.anytype.io/t/kanban-set-makes-useless-vertical-scrollbar/9807", "sir-coffee")}!`,
	),
	bullet(
		`Date & Time relations now properly sync with Daylight Savings Time in system settings. Thanks, ${link("https://community.anytype.io/t/due-dates-and-time-doesnt-apply-day-light-saving-timezones/9919", "Hexara")}!`,
	),
	bullet(
		`Years 0-99 are now supported in Date relations.Thanks, ${link("https://community.anytype.io/t/year-0-to-99-are-not-supported-in-any-date-relations/4957", "BlablaTalker")}!`,
	),
	bullet(
		`Relations combo box no longer hidden in Grid View for the last object of a large set. Thanks, ${link("https://community.anytype.io/t/relations-options-hide-the-editing-input-box/12622", "Hexara")}!`,
	),
	bullet(
		`When adding a new relation, system relations are now grouped in their own section at the bottom of the Relation Select Menu.`,
	),
	bullet(
		`Options in tag and status relations are now sorted alphabetically.`,
	),
	bullet(
		`Tooltip for new object button now shows object type which will be created.`,
	),
	bullet(`Mandarin input for text relations now working properly.`),
	bullet(
		`In the layout menu for Calendar view, ${hl(`Group relation`)} option has been changed to ${hl(`Date relation`)} for better clarity.`,
	),

	h3(`Tables:`),
	bullet(
		`Cell background color can now be changed. Thanks, ${link("https://community.anytype.io/t/randomly-unable-to-change-table-cells-background-color/11536", "Hexara")}!`,
	),
	bullet(
		`Double scrollbar no longer appearing when when opening the three-dots menu to edit the row/column. Thanks, ${link("https://community.anytype.io/t/table-menu-slider-positioning/12073", "WentAFK")}!`,
	),
	bullet(
		`Incorrect cell menu is no longer showing after last column is removed.`,
	),

	h3(`Editor:`),
	bullet(
		`Deleted text no longer reappears after block is deleted. Thanks, ${link("https://community.anytype.io/t/deleted-text-reappears-when-block-is-deleted/12233", "aero")}!`,
	),
	bullet(
		`Clicking the local file path link now opens the correct path. Thanks, ${link("https://community.anytype.io/t/clicking-on-a-local-file-path-link-only-opens-the-file-explorer-without-opening-the-path/12772", "4thHydro")}!`,
	),
	bullet(
		`Windows file path explorer now recognizes names with spaces. Thanks, ${link("https://community.anytype.io/t/windows-file-explorer-path-is-not-recognized-as-a-link-when-there-are-spaces-in-it/12771", "4thHydro")}!`,
	),
	bullet(
		`Default text color now works properly when selecting multicolored text strings. Thanks, ${link("https://community.anytype.io/t/default-font-color-does-not-remove-text-colors-consistently/9530", "Romi")}!`,
	),
	bullet(
		`Orange plus sign no longer disappears after making modifications to blocks. Thanks, ${link("https://community.anytype.io/t/plus-sign-disappears/11101", "Laurent_P")}!`,
	),
	bullet(
		`Typing <obj> no longer gets deleted from the editor. Thanks, ${link("https://community.anytype.io/t/typing-obj-gets-removed-immediately/12116", "Evan")}!`,
	),
	bullet(
		`Imported PDFs are no longer rendering in lower quality. Thanks, ${link("https://community.anytype.io/t/imported-pdf-is-shown-in-lower-quality/8600/23", "Flip")}!`,
	),
	bullet(
		`DnD in modal windows now correctly identifying cursor position. Thanks, ${link("https://community.anytype.io/t/drag-drop-in-modal-window-messed-up/11659", "LoyalOrange503")}!`,
	),

	h3(`Spellcheck:`),
	bullet(
		`Accepting spellcheck solution no longer changes text formatting. Thanks, ${link("https://community.anytype.io/t/accepting-spellcheck-solution-messes-with-formatting/11119", "SorryCantThinkOfANam")}!`,
	),
	bullet(
		`Accepting spellcheck solution no longer text color in previous letters. Thanks, ${link("https://community.anytype.io/t/spell-check-conflicts-with-text-color/8847", "jannis")}!`,
	),
	bullet(
		`Accepting spellcheck solution no longer adds letters before and after @ mentions. Thanks, ${link("https://community.anytype.io/t/strange-behavior-for-inline-mentions-while-using-the-spell-check-feature/10220", "dzlg")}!`,
	),
	bullet(
		`Spellcheck now working properly for text relations. Thanks, ${link("https://community.anytype.io/t/spell-check-feature-doesnt-work-in-text-type-relations/10230", "dzlg")}!`,
	),

	h3(`Graph:`),
	bullet(
		`Unlinked objects toggle now properly reflects unlinked objects when it is the only toggle selected. Thanks, ${link("https://community.anytype.io/t/graph-view-incorrect-behavior/9521", "Balcion")}!`,
	),
	bullet(
	...
	h3(`Other:`),
	bullet(
		`Deleting bookmark on second open page no longer redirects to previous open page. Thanks, ${link("https://community.anytype.io/t/bookmarks-pagination/10782", "Sergiu")}!`,
	),
	bullet(
		`Keyboard command inputs now work in English as well regardless of interface language. Thanks, ${link("https://community.anytype.io/t/commands-are-written-only-in-the-selected-language/10546", "Foxel")}!`,
	),
	bullet(
		`When creating links to other objects, object selection is now visually indicated in select menu. Thanks, ${link("https://community.anytype.io/t/object-selection-is-not-visually-indicated-for-link-to-object/12511", "Flip")}!`,
	),
	bullet(
		`Unexpected Javascript errors no longer occurring. Thanks, ${link("https://community.anytype.io/t/a-javascript-error-occurred-in-the-main-process/13271", "Ssussdriad")}!`,
	),
	bullet(
		`Clicking on title bar of object window no longer minimizes/maximizes Anytype window. Thanks, ${link("https://community.anytype.io/t/double-clicking-unexpected-behavior/8879", "Raphal")}!`,
	),
	bullet(
		`Space menu now displays spaces in the correct order when spaces are added from another device.`,
	),
	...
	bullet(
		`${hl("file://")} scheme is now properly working for links. Thanks, ${link("https://community.anytype.io/t/12820", "Filip")}!`,
	),
	bullet(
		`Fixed a bug preventing renaming inline sets or collections. Thanks, ${link("https://community.anytype.io/t/cannot-rename-an-inline-set-or-collection/12796", "Shampra")}!`,
	),
	bullet(
		`Emoji popup is no longer scrollable. Thanks, ${link("https://community.anytype.io/t/emoji-pop-up-become-scrollable-0-36-24-beta-and-later/12793", "PavloUA")}!`,
	),

	h2(`💻 Tech:`),
	bullet(
		`Inter font has been updated to version 4.0. Thanks, ${link("https://github.com/Linerly", "Linerly")}!`,
	),
	bullet(
		`Katex has been updated to 0.16.9 to fix crash when entering special symbols. Thanks, ${link("https://community.anytype.io/t/uncaught-katex-error-when-pasting-special-symbols-in-latex-block/12164", "Jannis")}!`,
	),
	...
	img("37/1.png"),
	text(
		`For all of you who’ve longingly admired the various setups others have shared in our ${link("https://community.anytype.io/c/gallery/27/none", "community showcase")}, or for those of you who’ve created incredible setups of your own that you’ve wished to share, the wait is over.`,
	),
	text(
		`Introducing: The ANY Experience gallery, a marketplace of use cases, templates, and setups where any member of our community can upload their own experience, or import an experience created by others. To browse the gallery, ${link("https://gallery.any.coop/", "click here")} (we’ve kickstarted the process with a few experiences of our own). If you’d like to contribute your own experience to the gallery, you can follow the instructions ${link("https://github.com/orgs/anyproto/discussions/123", "here")}.`,
	),
	...
	img("37/7.png"),
	text(
		`When selecting an object in the graph, you’ll have an option in the graph settings menu to toggle on ${hl("Local Graph")}, which will display only the selected object and its linked objects, rather than your entire graph.`,
	),
	...
	text(
		`When using the ${hl(`Ctrl + F`)} command in the editor, the search will now include content inside of closed toggles. If your search term is found inside the closed toggle, the toggle will open.`,
	),
	...
	h2(`💻 Tech:`),
	bullet(
		`Fixed application icons in Linux builds. Thanks, ${link("https://github.com/D-Brox", "D-Brox")}!`,
	),
	bullet(
		`Closed possible XSS attack vectors in block content. Thanks, ${link("https://github.com/dragosrotaru", "dragosrotaru")}!`,
	),

	h2(`🐛 Bug Fixes:`),
	bullet(
		`Calendar view now properly loads objects outside of current month. Thanks, ${link("https://community.anytype.io/t/objects-only-appear-in-their-months/12401", "edion86")}!`,
	),
	bullet(
		`Emojis & Mentions can now be easily deleted with backspace. Thanks, ${link("https://community.anytype.io/t/deleting-and-typing-with-emojis-via-ctrl-e-takes-awhile/2710", "whereisj9")}!`,
	),
	bullet(
		`Space key can now be used properly in @mention searches. Thanks, ${link("https://community.anytype.io/t/allow-using-spaces-in-object-name-during-linking-with/8373", "dzshch")}!`,
	),
	bullet(
		`Hovers for filter menu options are now working correctly for set & collection filters. Thanks, ${link("https://community.anytype.io/t/part-of-filter-doesnt-open-when-hover/11658", "PavloUA")}!`,
	),
	...
	bullet(
		`Value in the last cell of a row no longer disappears when using right arrow key. Thanks, ${link("https://community.anytype.io/t/value-in-last-cell-of-a-row-goes-missing-when-using-right-arrow/10468", "sambouwer")}!`,
	),
	...
	img(`35/3-menu.png`),
	text(
		`To simplify the process of adding web links to text blocks, inputting a URL as a text block link will bring Link to Website to the top of the menu. Thanks, ${link(`https://community.anytype.io/t/change-the-layout-of-link-in-font-settings/9757`, `gdbb`)}!`,
	),
	...
	bullet(
		`Search palette now correctly displays recently edited objects. Thanks, ${link(`https://community.anytype.io/t/search-palette-doesnt-show-most-recent-objects/9992`, `C.c`)}!`,
	),
	bullet(
		`Caret position no longer jumps when using the editor. Thanks, ${link(`https://community.anytype.io/t/cursor-jumping-back-while-typing-still-a-problem/10562/3`, `stujo7`)}!`,
	),
	bullet(
		`When selecting objects as relation value, sort is now applied according to descending values. Thanks, ${link(`https://community.anytype.io/t/inconsistent-sorting-on-macos-vs-ios/10716`, `Hoador`)}!`,
	),
	bullet(`Several layout problems in print version`),
	bullet(
		`View controllers for Sets &amp; Collections now remain visible regardless of window size. Thanks, ${link(`https://community.anytype.io/t/set-view-controllers-inaccessible-on-certain-screen-width/10301`, `raph`)}!`,
	),
	bullet(
		`Note snippets are no longer parsing HTML from code blocks. Thanks, ${link(`https://community.anytype.io/t/10589`, `CodeMacLife`)}!`,
	),
	bullet(
		`Copy and deleting relations before they are created is no longer enabled in Objects, Sets &amp; Collections`,
	),
	...
	text(
		`Please note that all translations from the English language are community-contributed. If you notice any errors, you're free to submit your corrections ${link(`https://community.anytype.io/t/localization-launch/10269/13`, `using this platform`)}. Any updates will be shipped in the successive release.`,
	),
	text(
		`Don't see your language? Feel free to ${link(`https://github.com/orgs/anyproto/discussions/45`, `start contributing your own translations`)}!`,
	),
	...
	img("34/2.png", "screen"),
	text(
		`Meanwhile, it's now possible to choose a default template for each type. From the types page, click the newly-added three-dots menu for the template, and click on the menu option ${hl(`Set as default`)}.`,
	),
	img("34/3.png", "screen"),
	text(
		`This template will now be applied each time you create an object from sets or collections, though you can customize the template according to each set view. When creating objects from the ${hl(`+`)} button or ${hl(`/`)} command menu, you will still be presented with a panel of templates to choose from.`,
	),
	...
	h2(`🐛 Bug Fixes:`),
	bullet(
		`Status/tag relation menus no longer opening editing interface on hover`,
	),
	bullet(
		`Cursor no longer dropping when adding link-in-text using keyboard shortcut`,
	),
	bullet(
		`Unreadable font color in dark mode for Notion imports has been fixed. Thanks, ${link(`https://community.anytype.io/t/dark-mode-font-color-hard-to-read/8445`, `kunthawat`)}!`,
	),
	bullet(
		`Numbered lists no longer reset from 40 onward. Thanks, ${link(`https://community.anytype.io/t/numbered-list-resets-after-40-items/10300`, `Rebo`)}!`,
	),
	bullet(
		`Relations added to objects after set creation are now showing in column view when toggled on. Thanks, ${link(`https://community.anytype.io/t/attributes-weird-behavior/9862`, `saifeldeen`)}!`,
	),
	bullet(`Text context menu is now opening properly for all selected blocks`),
	bullet(
		`Text relations no longer reverted to previous state in sets after being edited inside the object. Thanks, ${link(`https://community.anytype.io/t/url-source-relation-is-reset-or-set-to-previous-content-when-clicking-url-source-cell-in-set-grid-view/9484`, `xpdmk`)}!`,
	),
	bullet(
		`KaTeX has been updated to the latest version, permitting LaTeX blocks to render chemical equations. Thanks, ${link(`https://community.anytype.io/t/latex-not-rendering-ce/10326`, `jannis`)}!`,
	),
	bullet(
		`It is no longer possible to to double-press ${hl(`Enter`)} in paste menu. Thanks, ${link(`https://community.anytype.io/t/pasting-a-link-and-pressing-enter-repeatedly-results-in-pasting-the-link-twice/9453`, `sergiu`)}!`,
	),
	bullet(
		`Horizontal scrollbar in code blocks no longer appear in PDF exports or print versions. Thanks, ${link(`https://community.anytype.io/t/double-scrollbar-on-pdf-export-for-code-blocks-with-scrollbar/9864`, `jannis`)}!`,
	),
