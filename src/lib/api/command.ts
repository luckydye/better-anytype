import { Commands, Rpc, Model, Empty } from "@anytype/proto";
import { I, S, U, J, Mark, Storage, dispatcher, Encode, Mapper } from "Lib";

export const MetricsSetParameters = (
	platform: I.Platform,
	version: string,
...
export const GalleryDownloadManifest = (
	url: string,
	callBack?: (message: any) => void,
) => {
...
export const WalletCloseSession = (
	token: string,
	callBack?: (message: any) => void,
) => {
...
export const WorkspaceObjectListRemove = (
	objectIds: string[],
	callBack?: (message: any) => void,
) => {
...
export const AccountLocalLinkNewChallenge = (
	name: string,
	callBack?: (message: any) => void,
) => {
...
export const AccountLocalLinkSolveChallenge = (
	id: string,
	answer: string,
	callBack?: (message: any) => void,
) => {
...
export const NavigationGetObjectInfoWithLinks = (pageId: string, callBack?: (message: any) => void) => {
	...
	dispatcher.request(
		NavigationGetObjectInfoWithLinks.name,
		request,
		callBack,
	);
};
...
export const BlockDataviewCreateFromExistingObject = (
	...
	dispatcher.request(
		BlockDataviewCreateFromExistingObject.name,
		request,
		callBack,
	);
};

export const BlockSetCarriage = (
	contextId: string,
	blockId: string,
	range: I.TextRange,
	callBack?: (message: any) => void,
...
export const BlockWidgetSetTargetId = (
	contextId: string,
	blockId: string,
	targetId: string,
	callBack?: (message: any) => void,
...
export const BlockWidgetSetLayout = (
	contextId: string,
	blockId: string,
...
export const BlockWidgetSetLimit = (
	contextId: string,
	blockId: string,
	limit: number,
	callBack?: (message: any) => void,
...
export const BlockWidgetSetViewId = (
	contextId: string,
	blockId: string,
	viewId: string,
	callBack?: (message: any) => void,
...
export const BlockTextSetText = (
	...
	request.setMarks(
		new Model.Block.Content.Text.Marks().setMarksList(marks as any),
	);
...
export const BlockTextSetChecked = (
	contextId: string,
	blockId: string,
	checked: boolean,
	callBack?: (message: any) => void,
...
export const BlockSplit = (
	contextId: string,
	blockId: string,
	range: I.TextRange,
	style: I.TextStyle,
	mode: I.BlockSplitMode,
	callBack?: (message: any) => void,
) => {
...
export const BlockBookmarkFetch = (
	contextId: string,
	blockId: string,
	url: string,
	callBack?: (message: any) => void,
...
export const BlockListMoveToExistingObject = (
	contextId: string,
...
export const BlockListTurnInto = (
	contextId: string,
	blockIds: string[],
	style: I.TextStyle,
	callBack?: (message: any) => void,
...
export const BlockDivListSetStyle = (
	contextId: string,
	blockIds: string[],
	style: I.TextStyle,
	callBack?: (message: any) => void,
...
export const BlockLatexSetText = (
	contextId: string,
	blockId: string,
	text: string,
	callBack?: (message: any) => void,
...
export const BlockLinkListSetAppearance = (
	contextId: string,
	blockIds: any[],
	iconSize: I.LinkIconSize,
	cardStyle: I.LinkCardStyle,
...
export const BlockTableRowCreate = (
	contextId: string,
	targetId: string,
	position: I.BlockPosition,
	callBack?: (message: any) => void,
...
export const BlockTableRowDuplicate = (
	contextId: string,
	blockId: string,
	targetId: string,
	position: I.BlockPosition,
...
export const BlockTableRowListFill = (
	contextId: string,
	blockIds: string[],
	callBack?: (message: any) => void,
) => {
...
export const BlockTableRowListClean = (
	contextId: string,
	blockIds: string[],
	callBack?: (message: any) => void,
) => {
...
export const BlockTableRowSetHeader = (
	contextId: string,
	targetId: string,
	isHeader: boolean,
	callBack?: (message: any) => void,
...
export const BlockTableColumnCreate = (
	contextId: string,
	targetId: string,
	position: I.BlockPosition,
	callBack?: (message: any) => void,
...
export const BlockTableColumnDelete = (
	contextId: string,
	targetId: string,
	callBack?: (message: any) => void,
) => {
...
export const BlockTableColumnMove = (
	contextId: string,
	targetId: string,
	dropTargetId: string,
	position: I.BlockPosition,
...
export const BlockTableColumnDuplicate = (
	contextId: string,
	blockId: string,
	targetId: string,
	position: I.BlockPosition,
...
export const BlockTableColumnListFill = (
	contextId: string,
	blockIds: string[],
	callBack?: (message: any) => void,
) => {
...
export const BlockFileListSetStyle = (
	contextId: string,
	blockIds: string[],
	style: I.FileStyle,
	callBack?: (message: any) => void,
...
export const BlockFileSetTargetObjectId = (
	contextId: string,
	blockId: string,
	objectId: string,
	callBack?: (message: any) => void,
...
export const BlockTextListSetColor = (
	contextId: string,
	blockIds: string[],
	color: string,
	callBack?: (message: any) => void,
...
export const BlockTextListSetMark = (
	contextId: string,
	blockIds: string[],
	mark: I.Mark,
	callBack?: (message: any) => void,
...
export const BlockTextListSetStyle = (
	contextId: string,
	blockIds: string[],
	style: I.TextStyle,
	callBack?: (message: any) => void,
...
export const BlockTextListClearStyle = (
	contextId: string,
	blockIds: string[],
	callBack?: (message: any) => void,
) => {
...
export const BlockTextListClearContent = (
	contextId: string,
	blockIds: string[],
	callBack?: (message: any) => void,
) => {
...
export const BlockListSetFields = (
	contextId: string,
	fields: any,
	callBack?: (message: any) => void,
) => {
...
export const BlockListSetBackgroundColor = (
	contextId: string,
	blockIds: string[],
	color: string,
	callBack?: (message: any) => void,
...
export const BlockListSetAlign = (
	contextId: string,
	blockIds: string[],
	align: I.BlockHAlign,
	callBack?: (message: any) => void,
...
export const BlockListSetVerticalAlign = (
	contextId: string,
	blockIds: string[],
	align: I.BlockVAlign,
	callBack?: (message: any) => void,
...
export const BlockDataviewViewUpdate = (
	contextId: string,
	blockId: string,
	viewId: string,
	view: any,
...
export const BlockDataviewViewDelete = (
	contextId: string,
	blockId: string,
	viewId: string,
	callBack?: (message: any) => void,
...
export const BlockDataviewViewSetPosition = (
	contextId: string,
	blockId: string,
	viewId: string,
	position: number,
...
export const BlockDataviewFilterAdd = (
	contextId: string,
	blockId: string,
	viewId: string,
	filter: I.Filter,
...
export const BlockDataviewFilterRemove = (
	contextId: string,
	blockId: string,
	viewId: string,
	ids: string[],
...
export const BlockDataviewFilterReplace = (
	contextId: string,
	blockId: string,
	viewId: string,
	id: string,
...
export const BlockDataviewFilterSort = (
	contextId: string,
	blockId: string,
	viewId: string,
	ids: string[],
...
export const BlockDataviewSortAdd = (
	contextId: string,
	blockId: string,
	viewId: string,
	sort: I.Sort,
...
export const BlockDataviewSortRemove = (
	contextId: string,
	blockId: string,
	viewId: string,
	ids: string[],
...
export const BlockDataviewSortReplace = (
	contextId: string,
	blockId: string,
	viewId: string,
	id: string,
...
export const BlockDataviewSortSort = (
	contextId: string,
	blockId: string,
	viewId: string,
	ids: string[],
...
export const BlockDataviewViewRelationRemove = (
	contextId: string,
	blockId: string,
	viewId: string,
	relationKeys: string[],
...
export const BlockDataviewViewRelationReplace = (
	contextId: string,
	blockId: string,
	viewId: string,
	relationKey: string,
	...
	dispatcher.request(
		BlockDataviewViewRelationReplace.name,
		request,
		callBack,
	);
};

export const BlockDataviewViewRelationSort = (
	contextId: string,
	blockId: string,
	viewId: string,
	relationKeys: string[],
...
export const BlockDataviewViewSetActive = (
	contextId: string,
	blockId: string,
	viewId: string,
	callBack?: (message: any) => void,
...
export const BlockDataviewGroupOrderUpdate = (
	contextId: string,
	blockId: string,
	order: any,
	callBack?: (message: any) => void,
...
export const BlockDataviewObjectOrderUpdate = (
	contextId: string,
	blockId: string,
	orders: any[],
	callBack?: (message: any) => void,
...
export const BlockRelationSetKey = (
	contextId: string,
	blockId: string,
	relationKey: string,
	callBack?: (message: any) => void,
...
export const BlockDataviewRelationAdd = (
	contextId: string,
	blockId: string,
	relationKeys: string[],
	callBack?: (message: any) => void,
...
export const BlockDataviewRelationDelete = (
	contextId: string,
	blockId: string,
	relationKeys: string[],
	callBack?: (message: any) => void,
...
export const BlockDataviewSetSource = (
	contextId: string,
	blockId: string,
	sources: string[],
	callBack?: (message: any) => void,
...
export const BlockCreateWidget = (
	contextId: string,
	targetId: string,
	block: any,
	position: I.BlockPosition,
...
export const HistorySetVersion = (
	objectId: string,
	versionId: string,
	callBack?: (message: any) => void,
) => {
...
export const HistoryDiffVersions = (
	objectId: string,
	spaceId: string,
	current: string,
	previous: string,
...
export const ObjectTypeRelationAdd = (
	objectTypeId: string,
	relationKeys: string[],
	callBack?: (message: any) => void,
) => {
...
export const ObjectTypeRelationRemove = (
	objectTypeId: string,
	relationKeys: string[],
	callBack?: (message: any) => void,
) => {
...
export const ObjectCreateFromUrl = (
	details: any,
	spaceId: string,
	typeKey: string,
	url: string,
...
export const ObjectCreateRelation = (
	...
	details.relationFormat =
		Number(details.relationFormat) || I.RelationType.LongText;
...
export const RelationListRemoveOption = (
	optionIds: string[],
	checkInObjects: boolean,
	callBack?: (message: any) => void,
) => {
...
export const ObjectBookmarkFetch = (
	contextId: string,
	url: string,
	callBack?: (message: any) => void,
) => {
...
export const ObjectOpen = (
	...
	dispatcher.request(ObjectOpen.name, request, (message: any) => {
		...
		if (
			!object._empty_ &&
			![I.ObjectLayout.Dashboard].includes(object.layout)
		) {
			Storage.setLastOpened(windowId, {
				id: object.id,
...
export const ObjectImportNotionValidateToken = (
	token: string,
	callBack?: (message: any) => void,
) => {
...
export const ObjectImportUseCase = (
	spaceId: string,
	usecase: number,
	callBack?: (message: any) => void,
) => {
...
export const ObjectImportExperience = (
	spaceId: string,
	url: string,
	title: string,
	isNewSpace: boolean,
...
export const ObjectSetObjectType = (
	contextId: string,
	typeKey: string,
	callBack?: (message: any) => void,
) => {
...
export const ObjectListSetDetails = (
	objectIds: string[],
	details: any[],
	callBack?: (message: any) => void,
) => {
...
export const ObjectSearchWithMeta = (
	filters: I.Filter[],
	sorts: I.Sort[],
	keys: string[],
	fullText: string,
...
export const ObjectSearchUnsubscribe = (
	subIds: string[],
	callBack?: (message: any) => void,
) => {
...
export const ObjectRelationAdd = (
	contextId: string,
	relationKeys: string[],
	callBack?: (message: any) => void,
) => {
...
export const ObjectRelationDelete = (
	contextId: string,
	relationKeys: string[],
	callBack?: (message: any) => void,
) => {
...
export const ObjectRelationAddFeatured = (
	contextId: string,
	keys: string[],
	callBack?: (message: any) => void,
) => {
...
export const ObjectRelationRemoveFeatured = (
	contextId: string,
	keys: string[],
	callBack?: (message: any) => void,
) => {
...
export const ObjectSetIsFavorite = (
	contextId: string,
	isFavorite: boolean,
	callBack?: (message: any) => void,
) => {
...
export const ObjectToCollection = (
	contextId: string,
	callBack?: (message: any) => void,
) => {
...
export const ObjectApplyTemplate = (
	contextId: string,
	templateId: string,
	callBack?: (message: any) => void,
) => {
...
export const ObjectCollectionAdd = (
	contextId: string,
	objectIds: string[],
	callBack?: (message: any) => void,
) => {
...
export const ObjectCollectionRemove = (
	contextId: string,
	objectIds: string[],
	callBack?: (message: any) => void,
) => {
...
export const ObjectCollectionSort = (
	contextId: string,
	objectIds: string[],
	callBack?: (message: any) => void,
) => {
...
export const ObjectListSetIsArchived = (
	ids: string[],
	isArchived: boolean,
	callBack?: (message: any) => void,
) => {
...
export const ObjectListSetIsFavorite = (
	ids: string[],
	isFavorite: boolean,
	callBack?: (message: any) => void,
) => {
...
export const ObjectListSetObjectType = (
	ids: string[],
	typeKey: string,
	callBack?: (message: any) => void,
) => {
...
export const TemplateExportAll = (
	path: string,
	callBack?: (message: any) => void,
) => {
...
export const DebugExportLocalstore = (
	path: string,
	ids: string[],
	callBack?: (message: any) => void,
) => {
...
export const DebugStackGoroutines = (
	path: string,
	callBack?: (message: any) => void,
) => {
...
export const NotificationReply = (
	ids: string[],
	action: I.NotificationAction,
	callBack?: (message: any) => void,
) => {
...
export const NameServiceResolveName = (
	name: string,
	callBack?: (message: any) => void,
) => {
...
export const MembershipGetStatus = (
	noCache: boolean,
	callBack?: (message: any) => void,
) => {
...
export const MembershipGetTiers = (
	noCache: boolean,
	locale: string,
	callBack?: (message: any) => void,
) => {
...
export const MembershipIsNameValid = (
	tier: I.TierType,
	name: string,
	callBack?: (message: any) => void,
) => {
...
export const MembershipRegisterPaymentRequest = (
	tier: I.TierType,
	...
	dispatcher.request(
		MembershipRegisterPaymentRequest.name,
		request,
		callBack,
	);
};

export const MembershipGetPortalLinkUrl = (
	callBack?: (message: any) => void,
) => {
...
export const MembershipGetVerificationEmail = (
	email: string,
...
export const MembershipVerifyEmailCode = (
	code: string,
	callBack?: (message: any) => void,
) => {
...
export const MembershipFinalize = (
	name: string,
	callBack?: (message: any) => void,
) => {
...
export const SpaceInviteGenerate = (
	spaceId: string,
	callBack?: (message: any) => void,
) => {
...
export const SpaceInviteRevoke = (
	spaceId: string,
	callBack?: (message: any) => void,
) => {
...
export const SpaceInviteGetCurrent = (
	spaceId: string,
	callBack?: (message: any) => void,
) => {
...
export const SpaceMakeShareable = (
	spaceId: string,
	callBack?: (message: any) => void,
) => {
	const request = new Rpc.Space.StopSharing.Request();
...
export const SpaceRequestApprove = (
	spaceId: string,
	identity: string,
...
export const SpaceRequestDecline = (
	spaceId: string,
	identity: string,
	callBack?: (message: any) => void,
) => {
...
export const SpaceParticipantPermissionsChange = (
	spaceId: string,
	changes: any[],
	callBack?: (message: any) => void,
) => {
	...
	dispatcher.request(
		SpaceParticipantPermissionsChange.name,
		request,
		callBack,
	);
};

export const SpaceParticipantRemove = (
	spaceId: string,
	identities: string[],
	callBack?: (message: any) => void,
) => {
...
export const SpaceLeaveApprove = (
	spaceId: string,
	identities: string[],
	callBack?: (message: any) => void,
) => {
...
export const BroadcastPayloadEvent = (
	payload: any,
	callBack?: (message: any) => void,
) => {
