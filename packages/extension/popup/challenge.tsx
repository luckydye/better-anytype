...
import { type I, C, S, U, Storage } from "Lib";
...
const Challenge = observer(
	class Challenge extends React.Component<I.PageComponent, State> {
		ref: any = null;
		state = {
			error: "",
		};
		...
		onSuccess() {
			C.AccountLocalLinkSolveChallenge(
				S.Extension.challengeId,
				this.ref?.getValue().trim(),
				(message: any) => {
